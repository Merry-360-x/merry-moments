...
class _SlideToConfirmButtonState extends State<SlideToConfirmButton>
  ...
  void _snapTo(double target) {
    _animCtrl
      ...
      ..animateTo(
        target,
        duration: Duration(milliseconds: target == 0.0 ? 350 : 300),
        curve: target == 1.0 ? Curves.easeOutBack : Curves.easeOutCubic,
      );
  }

  void _onDragUpdate(DragUpdateDetails details) {
    if (_isConfirmed || widget.disabled || widget.isProcessing) return;
    _isDragging = true;
  ...
  Widget build(BuildContext context) {
    ...
    final bool showProcessing = widget.isProcessing;
    final bool showSuccessAnim = widget.showSuccess;
    final bool isLocked =
        _isConfirmed || showProcessing || showSuccessAnim || widget.disabled;
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: showSuccessAnim || _isConfirmed
                        ? activeColor
                        : trackColor,
                    borderRadius:
